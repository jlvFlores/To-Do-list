...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_add_remove_list_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/add-remove-list.js */ \"./src/modules/add-remove-list.js\");\n/* harmony import */ var _modules_status_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/status.js */ \"./src/modules/status.js\");\n\n\n\n\n_modules_add_remove_list_js__WEBPACK_IMPORTED_MODULE_1__.renderList();\n\n// EVENT LISTENERS\nconst addBtn = document.getElementById('add-button');\naddBtn.addEventListener('click', () => {\n  const inputValue = document.getElementById('add-input');\n  if (inputValue.value) {\n    _modules_add_remove_list_js__WEBPACK_IMPORTED_MODULE_1__.addToList(inputValue.value);\n    inputValue.value = '';\n    inputValue.focus();\n  }\n});\n\nconst checkboxes = document.querySelectorAll('.checkbox');\ncheckboxes.forEach((checkbox) => {\n  checkbox.addEventListener('change', () => (0,_modules_status_js__WEBPACK_IMPORTED_MODULE_2__.updateStatus)(checkbox));\n});\n\nconst descTextareas = document.querySelectorAll('.desc');\ndescTextareas.forEach((textarea) => {\n  textarea.addEventListener('keyup', (e) => _modules_add_remove_list_js__WEBPACK_IMPORTED_MODULE_1__.updateDescription(e.target.dataset.ta, textarea.value));\n});\n\nconst removeBtns = document.querySelectorAll('.erase');\nremoveBtns.forEach((button) => {\n  button.addEventListener('click', (e) => _modules_add_remove_list_js__WEBPACK_IMPORTED_MODULE_1__.removeItem(e.target.dataset.id));\n});\n\nconst clearBtn = document.querySelector('.clear-completed');\nclearBtn.addEventListener('click', () => _modules_add_remove_list_js__WEBPACK_IMPORTED_MODULE_1__.clearCompleted());\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"updateStatus\": () => (/* binding */ updateStatus)\n/* harmony export */ });\n/* harmony import */ var _add_remove_list_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-remove-list.js */ \"./src/modules/add-remove-list.js\");\n\r\n\r\nconst updateStatus = (checkbox) => {\r\n  let id = parseInt(checkbox.parentElement.id - 1);\r\n  checkbox.checked ? _add_remove_list_js__WEBPACK_IMPORTED_MODULE_0__.listArray[id].completed = true : _add_remove_list_js__WEBPACK_IMPORTED_MODULE_0__.listArray[id].completed = false;\r\n  (0,_add_remove_list_js__WEBPACK_IMPORTED_MODULE_0__.updateLocalStorage)();\r\n};\n\n//# sourceURL=webpack://to-do-list/./src/modules/status.js?");
